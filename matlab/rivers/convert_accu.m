...
% for time conversion into meter per 3 hours
% for other units convertions : https://www.researchgate.net/post/How_do_I_convert_ERA_Interim_precipitation_estimates_from_kg_m2_s_to_mm_day

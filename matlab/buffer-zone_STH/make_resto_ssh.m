...
% 
% modified by Eliott on  Wednesday  28/11/2018
% 
% Uses write_resto.m and write_resto_ssh.m
...
fileName = '/home/eliott/PFE/resto_ssh/SSHDMP/resto_MED12.nc';
filename_output =  '/home/eliott/PFE/working_directory/25_Layers_input/buffer_zone_2018_11_28/resto_ssh.nc' ;
    %'/home/lifewatch-user/working_directory/25_Layers_input/buffer_zone_2018_07_28/resto.nc';
filename_mask  = '/home/eliott/PFE/working_directory/25_Layers_input/buffer_zone_2018_11_28/mesh_mask.nc' ;
    %'/home/lifewatch-user/working_directory/25_Layers_input/buffer_zone_2018_07_28/mesh_mask.nc';
...
%% creation of the resto_ssh field

resto_ssh_field(:,:) =  mask_field(:,:,1) * 0;

resto_ssh_field(:,:) =  write_resto_ssh(mask_field, resto_ssh_field)/time_scale ;
...
%     Create attributes associated with the variable Z
    ...
    varid_resto_ssh = netcdf.defVar(ncid,'restossh','NC_FLOAT',[dimidX, dimidY]);
...
%     netcdf.putVar(ncid,varidY,Yq(:,1));
    ...
    netcdf.putVar(ncid,varid_resto_ssh,resto_ssh_field);
